...
- \`/important/importante.md\` → Manifiesto Hacker (sin valor técnico, ambientación del lab)
...
Máquina con cadena de explotación más completa que Tproot: enumeración FTP/web, recolección de credenciales desde archivos filtrados, fuerza bruta dirigida por SSH y escalada de privilegios vía mala configuración de sudoers. Buen ejercicio para reforzar:
...
- [GTFOBins](https://gtfobins.github.io/) como referencia para explotar binarios con permisos de sudo/SUID mal configurados
