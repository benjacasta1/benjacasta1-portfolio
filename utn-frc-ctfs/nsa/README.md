...
**Acceso inicial:** SQL Injection mediante manipulación del parámetro `txtPin`
...
- Validar el input en el servidor (longitud, tipo, formato del PIN).
- No confiar en restricciones del lado del cliente (`type="password"`) como control de seguridad.
